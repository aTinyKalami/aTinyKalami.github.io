...
#### DSA（DeepSeek Sparse Attention (DeepSeek 细粒度稀疏注意力 机制)
...
推理成本降低带来的模型Token API调用的成本大幅降低：

！[DeepSeek V3.2 价格变化](https://api-docs.deepseek.com/zh-cn/img/v3_2_price_zh.webp)
